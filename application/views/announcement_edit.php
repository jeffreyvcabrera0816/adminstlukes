  	       ...
  	       <h3>Edit Annoucement</h3>
  	         <div class="tab-content">
				...
				<div class="tab-pane active" id="horizontal-form">
					<form class="form-horizontal" action="<?php echo base_url(); ?>announcements/edit_execute" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea name="content" style="height:140px" rows="10" type="text" class="form-control1" id="focusedinput" placeholder="Announcement"><?=$data['announcement']?></textarea>
							</div>
						</div>
						...
						<div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button class="btn-success btn bg-green">Update</button>
